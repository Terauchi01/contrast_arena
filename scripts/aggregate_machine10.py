#!/usr/bin/env python3
"""
Aggregate results for machine10-* runs.

Scans logs/machine10*/server*.log and prints counts for the fixed match list
in the requested order as CSV: left,right,X_wins,O_wins,Draws,Total

Usage: python3 scripts/aggregate_machine10.py [logs_dir_prefix]
...
LOG_GLOB = os.path.join(BASE_LOG_DIR, 'machine10*', 'server*.log')
